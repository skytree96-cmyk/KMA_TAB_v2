...
with company_tab:
    ...
    st.markdown(
        ...
        8. 교육 전·후 비교는 최대 8개 역량의 레이더 그래프와 상세표로 확인합니다. 별도 파일 비교가 필요할 때만 하단 **CSV 파일로 직접 비교하기**를 펼쳐 업로드합니다.
        9. 역량별 짝지은 유효 참여자 N≥5 결과에서 변화와 수행기회·전이 장애요인을 확인하고 `인쇄용 리포트 HTML`을 내려받습니다.
        """
    )
